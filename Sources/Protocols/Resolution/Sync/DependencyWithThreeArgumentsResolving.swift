//
//  DependencyWithThreeArgumentsResolving.swift
//
//
...
/// A type that is able to resolve a dependency with three given variable arguments
...
public extension DependencyWithThreeArgumentsResolving {
    /// Resolve a dependency with three variable arguments that was previously registered within the container
    ///
