...
final class AsyncComplexTests: AsyncDITestCase {
    ...
    func testCombiningSharedAndNonsharedDependencies() async {
        ...
        let resolvedDependency3 = await container.resolve(type: DependencyWithParameter3.self, arguments: argumentDependency1)
        let resolvedDependency4 = await container.resolve(type: DependencyWithParameter3.self, arguments: argumentDependency2)
