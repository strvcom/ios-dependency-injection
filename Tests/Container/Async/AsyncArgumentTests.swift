...
final class AsyncContainerArgumentTests: AsyncDITestCase {
    func testRegistration() async {
        ...
        let resolvedDependency: DependencyWithValueTypeParameter = await container.resolve(arguments: argument)
    ...
    func testUnmatchingArgumentType_ZeroArguments() async {
        ...
        do {
            _ = try await container.tryResolve(type: SimpleDependency.self, arguments: argument)
    ...
    func testUnmatchingArgumentType_OneArgument() async {
        ...
        do {
            _ = try await container.tryResolve(type: DependencyWithValueTypeParameter.self, arguments: argument)
    ...
    func testRegistrationWithAsyncInit() async {
        ...
        let argument = StructureDependency(property1: "48")
        let resolvedDependency: DependencyWithAsyncInitWithParameter = await container.resolve(arguments: argument)
    ...
    func testRegistrationWithTwoArguments() async {
        ...
        let argument2 = "test2"
        let resolvedDependency: DependencyWithTwoArguments = await container.resolve(arguments: argument1, argument2)
    ...
    func testUnmatchingArgumentType_TwoArguments() async {
        ...
        do {
            _ = try await container.tryResolve(type: DependencyWithTwoArguments.self, arguments: argument1, argument2)
    ...
    func testRegistrationWithThreeArguments() async {
        ...
        let argument2 = "test2"
        let argument3 = 42
        let resolvedDependency: DependencyWithThreeArguments = await container.resolve(arguments: argument1, argument2, argument3)
    ...
    func testUnmatchingArgumentType_ThreeArguments() async {
        ...
        do {
            _ = try await container.tryResolve(type: DependencyWithThreeArguments.self, arguments: argument1, argument2, argument3)
    ...
    func testRegistrationWithAsyncInitWithTwoArguments() async {
        ...
        let argument1 = StructureDependency(property1: "test1")
        let argument2 = "test2"
        let resolvedDependency: DependencyWithAsyncInitWithTwoArguments = await container.resolve(arguments: argument1, argument2)
    ...
    func testRegistrationWithAsyncInitWithThreeArguments() async {
        ...
        let argument2 = "test2"
        let argument3 = 42
        let resolvedDependency: DependencyWithAsyncInitWithThreeArguments = await container.resolve(arguments: argument1, argument2, argument3)
