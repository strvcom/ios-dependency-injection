...
final class ContainerArgumentTests: DITestCase {
    func testRegistration() {
        ...
        let resolvedDependency: DependencyWithValueTypeParameter = container.resolve(arguments: argument)
    ...
    func testUnmatchingArgumentType_ZeroArguments() {
        ...
        XCTAssertThrowsError(
            try container.tryResolve(type: SimpleDependency.self, arguments: argument),
    ...
    func testUnmatchingArgumentType_OneArgument() {
        ...
        XCTAssertThrowsError(
            try container.tryResolve(type: DependencyWithValueTypeParameter.self, arguments: argument),
            "Resolver didn't throw an error"
        ) { error in
            guard let resolutionError = error as? ResolutionError else {
                XCTFail("Incorrect error type")
    ...
    func testRegistrationWithTwoArguments() {
        ...
        let argument2 = "test2"
        let resolvedDependency: DependencyWithTwoArguments = container.resolve(arguments: argument1, argument2)
    ...
    func testUnmatchingArgumentType_TwoArguments() {
        ...
        XCTAssertThrowsError(
            try container.tryResolve(type: DependencyWithTwoArguments.self, arguments: argument1, argument2),
            "Resolver didn't throw an error"
        ) { error in
            guard let resolutionError = error as? ResolutionError else {
                XCTFail("Incorrect error type")
    ...
    func testRegistrationWithThreeArguments() {
        ...
        let argument2 = "test2"
        let argument3 = 42
        let resolvedDependency: DependencyWithThreeArguments = container.resolve(arguments: argument1, argument2, argument3)
    ...
    func testUnmatchingArgumentType_ThreeArguments() {
        ...
        XCTAssertThrowsError(
            try container.tryResolve(type: DependencyWithThreeArguments.self, arguments: argument1, argument2, argument3),
            "Resolver didn't throw an error"
        ) { error in
            guard let resolutionError = error as? ResolutionError else {
                XCTFail("Incorrect error type")
