...
final class ComplexTests: DITestCase {
    ...
    func testCombiningSharedAndNonsharedDependencies() {
        ...
        let resolvedDependency3 = container.resolve(type: DependencyWithParameter3.self, arguments: argumentDependency1)
        let resolvedDependency4 = container.resolve(type: DependencyWithParameter3.self, arguments: argumentDependency2)
